                    ...
                    <div class="page-header">
                        <div class="page-block">
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <h5 class="m-b-10">Appointment History</h5>
                                    <p class="mb-0">View past appointments and their details.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            @forelse($appointments as $appointment)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge badge-secondary">{{ ucfirst($appointment->status) }}</span>
                                                    </td>
                                                    <td>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="6" class="text-center">No appointment history
                                                        found.</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
