    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">@lang('messages.contact_us')</span>
          <h1 class="text-capitalize mb-5 text-lg">@lang('messages.get_in_touch')</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input name="name" id="name" type="text" class="form-control" placeholder="@lang('messages.name')" >
                            </div>
                        </div>

                        <div class="col-lg-6">
                            <div class="form-group">
                                <input name="email" id="email" type="email" class="form-control" placeholder="@lang('messages.email')">
                            </div>
                        </div>
                         <div class="col-lg-6">
                            <div class="form-group">
                                <input name="subject" id="subject" type="text" class="form-control" placeholder="@lang('messages.query_topic')">
                            </div>
                        </div>
                         <div class="col-lg-6">
                            <div class="form-group">
                                <input name="phone" id="phone" type="text" class="form-control" placeholder="@lang('messages.phone_number')">
                            </div>
                        </div>
                    </div>

                    <div class="form-group-2 mb-4">
                        <textarea name="message" id="message" class="form-control" rows="8" placeholder="@lang('messages.message')"></textarea>
                    </div>
