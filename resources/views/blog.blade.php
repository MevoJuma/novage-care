            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarmain">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <div class="d-flex"> <a href="{{ url('/dashboard') }}"
                                class="btn btn-main-2 btn-icon">@lang('messages.login')</a></div>
        ...
        {{-- <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
            ...
            @foreach (['en' => 'English', 'sw' => 'Swahili'] as $locale => $language)
                ...
                <div class="form-group">
                    ...
                    <textarea name="content[{{ $locale }}]" rows="5" class="form-control" required></textarea>
                </div>
            @endforeach
